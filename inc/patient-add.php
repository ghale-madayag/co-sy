			...
			<div class="box-body">
				...
				<div class="col-xs-6">
					...
					<div class="form-group">
						...
						<input type="text" name="mname" id="mname" class="form-control" maxlength="1">
			...
			<div class="box-body">
				...
				<div class="col-xs-6">
					...
					<div class="form-group">
						...
						<input type="number" name="wei" id="wei" class="form-control" placeholder="kg" required onkeyup="bmiComputation($(this).val(),$('#hei').val());" maxlength="10">
					...
					<div class="col-xs-6">
						...
						<div class="form-group">
							...
							<input type="number" maxlength="10" name="hei" id="hei" class="form-control" placeholder="cm" required onkeyup="bmiComputation($('#wei').val(),$(this).val());">
	...
	<div class="col-md-8">
		<div class="box box-default">
			...
			<div class="box-footer">
				...
				<button type="submit" name="regnew" class="btn btn-success pull-right">Register Patient</button>
