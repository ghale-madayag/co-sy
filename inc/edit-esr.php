<div class="row">
	<form method="post" id="form-esr-edit" enctype="multipart/form-data">
	<div class="col-md-8">
		<div class="box box-default">
				...
				<div class="row">
					<div class="col-xs-6">
						<div class="form-group">
                            ...
                            <input type="hidden" id="esrid" name="esrid">
			...
			<div class="box-footer" style="padding:20px;">
				<button type="submit" name="regnew" class="btn btn-success pull-right">Edit Report</button>
			</div>
		</div>
	</div>
	</form>
