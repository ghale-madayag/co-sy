<div class="row">
	...
	<form method="post" id="form-usr-edit" enctype="multipart/form-data">
	...
	<div class="col-md-8">
		...
		<div class="box box-default">
					...
					<div class="col-xs-6">
						...
						<div class="form-group">
							...
							<select class="form-control" name="opm" id="opm">
			                    ...
			                    <option value="Present, Specifically">Present, Specifically</option>
			...
			<div class="box-footer" style="padding:20px;">
				...
				<button type="submit" name="edit" class="btn btn-success pull-right">Edit Report</button>
